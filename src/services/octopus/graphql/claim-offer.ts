...
import type { ClaimOfferMutation } from "#/graphql/graphql";
...
const MUTATION = graphql(`
  mutation ClaimOffer($accountNumber: String!, $offerSlug: String!) {
    claimOctoplusReward(accountNumber: $accountNumber, offerSlug: $offerSlug) {
      rewardId
    }
  }
`);
export type ClaimOfferResp = ClaimOfferMutation;
